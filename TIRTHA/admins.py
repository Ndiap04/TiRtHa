...
from Tirtha.helpers.handlers import skip_current_song, skip_item
from Tirtha.helpers.queues import QUEUE, clear_queue
...
async def skip(client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        OP = "**🗑️Removed the following songs from the Queue:-**"
        if chat_id in QUEUE:
