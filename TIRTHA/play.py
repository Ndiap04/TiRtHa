...
from Tirtha.helpers.queues import QUEUE, add_to_queue, get_queue

BILLIPOTO = [
    "https://te.legra.ph/file/a50e60f059d7a2d958c4d.jpg",
    "https://te.legra.ph/file/a50e60f059d7a2d958c4d.jpg",
]

IMAGE_THUMBNAIL = random.choice(BILLIPOTO)
    ...
    if replied:
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    photo="https://te.legra.ph/file/a50e60f059d7a2d958c4d.jpg",
                    caption=f"""
**▶Song In Queue Is{pos}
🏷Title: [{songname}]({link})
💡Status: Playing
        ...
        if replied.video or replied.document:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    photo="https://te.legra.ph/file/a50e60f059d7a2d958c4d.jpg",
                    caption=f"""
**▶Videos In Queue To {post}
️🏷️Title: [{songname}]({link})
💡Status: Playing
...
""",
        ...
        if len(m.command) < 2:
            ...
            await m.delete()
            huehue = await m.reply("**Song Search ... Please Be Patient**")
            query = m.text.split(None, 1)[1]
            search = ytsearch(query)
            Q = 720
            hmmm = HighQualityVideo()
